...
| 075 | [Sort colors](https://leetcode.com/problems/sort-colors/)|[Solution](https://github.com/Cecilia-xu/Leetcode/blob/master/75/Solution.md)|Medium|O(n)|O(1)|Array, Sort|[Note](https://github.com/Cecilia-xu/Leetcode/blob/master/75/Note.md)|
| 088 | [Merge Sorted Array](https://leetcode.com/problems/merge-sorted-array/)|[Solution](https://github.com/Cecilia-xu/Leetcode/blob/master/88/Solution.md)|Medium|O(n)|O(1)|Array, Sort|[Note](https://github.com/Cecilia-xu/Leetcode/blob/master/88/Note.md)|
...
| 001 | [Two Sum](https://leetcode.com/problems/two-sum/)|[Solution](https://github.com/Cecilia-xu/Leetcode/blob/master/1/Solution.md)|Easy|O()|O()|Hash Table|[Note](https://github.com/Cecilia-xu/Leetcode/blob/master/1/Note.md)|
## Bit Manipulation
| No | Title | Solution | Difficulty | Time | Space | Tag | Note |
| :----- | :-----: | :----------: |:------: |:------: |:------: |:------: |:----:|
