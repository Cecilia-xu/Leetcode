...
| 374 | [Guess Number Higher or Lower](https://leetcode.com/problems/guess-number-higher-or-lower/)|[Solution](https://github.com/Cecilia-xu/Leetcode/blob/master/374/Solution.md)|Easy, binary search|O(logn)|O(1)|Array|[Note](https://github.com/Cecilia-xu/Leetcode/blob/master/374/Note.md)|
