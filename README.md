...
| 26 | [Remove Duplicates from Sorted Array](https://leetcode.com/problems/remove-duplicates-from-sorted-array/)|[Solution](https://github.com/Cecilia-xu/Leetcode/blob/master/26/Solution.md)|Easy|O(n)|O(1)|Array,Greedy|[Note](https://github.com/Cecilia-xu/Leetcode/blob/master/26/Note.md)|
