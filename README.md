...
| 06 | [Binary Search tree(incomplete)](https://leetcode.com/explore/learn/card/introduction-to-data-structure-binary-search-tree/141/basic-operations-in-a-bst/)|[Note]()|
## Data structure 
...
| 027 | [Remove Element](https://leetcode.com/problems/remove-element/)|[Solution](https://github.com/Cecilia-xu/Leetcode/blob/master/027/Solution.md)|Easy|O(n)|O(1)|Array, Two pointers|[Note](https://github.com/Cecilia-xu/Leetcode/blob/master/027/Note.md)|
| 026 | [Remove Duplicates from Sorted Array](https://leetcode.com/problems/remove-duplicates-from-sorted-array/)|[Solution](https://github.com/Cecilia-xu/Leetcode/blob/master/026/Solution.md)|Easy|O(n)|O(1)|Array, Two pointers|[Note](https://github.com/Cecilia-xu/Leetcode/blob/master/026/Note.md)|
| 080 | [Remove Duplicates from Sorted Array II](https://leetcode.com/problems/remove-duplicates-from-sorted-array-ii/)|[Solution](https://github.com/Cecilia-xu/Leetcode/blob/master/080/Solution.md)|Medium|O(n)|O(1)|Array, Two pointers|[Note](https://github.com/Cecilia-xu/Leetcode/blob/master/080/Note.md)|
| 075 | [Sort colors](https://leetcode.com/problems/sort-colors/)|[Solution](https://github.com/Cecilia-xu/Leetcode/blob/master/075/Solution.md)|Medium|O(n)|O(1)|Array, Sort|[Note](https://github.com/Cecilia-xu/Leetcode/blob/master/075/Note.md)|
| 088 | [Merge Sorted Array](https://leetcode.com/problems/merge-sorted-array/)|[Solution](https://github.com/Cecilia-xu/Leetcode/blob/master/088/Solution.md)|Medium|O(n)|O(1)|Array, Sort|[Note](https://github.com/Cecilia-xu/Leetcode/blob/master/088/Note.md)|
| 215 | [ Kth Largest Element in an Array](https://leetcode.com/problems/kth-largest-element-in-an-array/)|[Solution](https://github.com/Cecilia-xu/Leetcode/blob/master/215/Solution.md)|Medium|O(nlogn)|O(1)|Array, Sort|[Note](https://github.com/Cecilia-xu/Leetcode/blob/master/215/Note.md)|
...
| 066 | [Plus One](https://leetcode.com/problems/plus-one/)|[Solution](https://github.com/Cecilia-xu/Leetcode/blob/master/066/Solution.md)|Easy|O(n)|O(1)|Array|[Note](https://github.com/Cecilia-xu/Leetcode/blob/master/066/Note.md)|
...
| No | Title | Solution | Difficulty | Time | Space | Tag | Note |
| :----- | :-----: | :----------: |:------: |:------: |:------: |:------: |:----:|
| 014 |[Longest Common Prefix](https://leetcode.com/problems/longest-common-prefix/)|[Solution](https://github.com/Cecilia-xu/Leetcode/blob/master/014/Solution.md)|Easy|O(n)|O(1)|String|[Note](https://github.com/Cecilia-xu/Leetcode/blob/master/014/Note.md)|
...
| 125 |[Valid Palindrome](https://leetcode.com/problems/valid-palindrome/)|[Solution](https://github.com/Cecilia-xu/Leetcode/blob/master/125/Solution.md)||O(n)|O(1)|String|[Note](https://github.com/Cecilia-xu/Leetcode/blob/master/125/Note.md)|
## Stack
| No | Title | Solution | Difficulty | Time | Space | Tag | Note |
| :----- | :-----: | :----------: |:------: |:------: |:------: |:------: |:----:|
...
| 155 |[Min Stack](https://leetcode.com/problems/min-stack/)|[Solution](https://github.com/Cecilia-xu/Leetcode/blob/master/155/Solution.md)|Easy|-|-|Stack, Design|[Note](https://github.com/Cecilia-xu/Leetcode/blob/master/155/Note.md)|
...
| 232 |[Implement Queue using Stacks](https://leetcode.com/problems/implement-queue-using-stacks/)|[Solution](https://github.com/Cecilia-xu/Leetcode/blob/master/232/Solution.md)|Easy, Design|-|-|Stack|[Note](https://github.com/Cecilia-xu/Leetcode/blob/master/232/Note.md)|
## Queue
| No | Title | Solution | Difficulty | Time | Space | Tag | Note |
| :----- | :-----: | :----------: |:------: |:------: |:------: |:------: |:----:|
...
| 069 |[Sqrt(x)](https://leetcode.com/problems/sqrtx/)|[Solution](https://github.com/Cecilia-xu/Leetcode/blob/master/069/Solution.md)|Easy|O(logn)|O(1)|Array, binary search|[Note](https://github.com/Cecilia-xu/Leetcode/blob/master/069/Note.md)|
| 033 |[Search in Rotated Sorted Array](https://leetcode.com/problems/search-in-rotated-sorted-array/)|[Solution](https://github.com/Cecilia-xu/Leetcode/blob/master/033/Solution.md)|Medium|O(logn)|O(1)|Array, binary search|[Note](https://github.com/Cecilia-xu/Leetcode/blob/master/033/Note.md)|
| 034 | [Find First and Last Position of Element in Sorted Array](https://leetcode.com/problems/find-first-and-last-position-of-element-in-sorted-array/)|[Solution](https://github.com/Cecilia-xu/Leetcode/blob/master/034/Solution.md)|Medium|O(logn)|O(1)|Array, binary search|[Note](https://github.com/Cecilia-xu/Leetcode/blob/master/034/Note.md)|
...
| 242 | [Valid Anagram](https://leetcode.com/problems/valid-anagram/)|[Solution](https://github.com/Cecilia-xu/Leetcode/blob/master/242/Solution.md)|Easy|O(n)|O(1)|Hash Table|[Note](https://github.com/Cecilia-xu/Leetcode/blob/master/242/Note.md)|
| 001 | [Two Sum](https://leetcode.com/problems/two-sum/)|[Solution](https://github.com/Cecilia-xu/Leetcode/blob/master/001/Solution.md)|Easy|O(n)|O(n)|Hash Table|[Note](https://github.com/Cecilia-xu/Leetcode/blob/master/001/Note.md)|
...
| 359 | [Logger Rate Limiter](https://leetcode.com/problems/logger-rate-limiter/)|[Solution](https://github.com/Cecilia-xu/Leetcode/blob/master/359/Solution.md)|Easy|O(1)|O(n)/O(1)|Hash Table, Design|[Note](https://github.com/Cecilia-xu/Leetcode/blob/master/359/Note.md)|
...
| 137 |[Single Number II](https://leetcode.com/problems/single-number-ii/)|[Solution](https://github.com/Cecilia-xu/Leetcode/blob/master/137/Solution.md)|Medium|O(n)|O(1)|Bit Manipulation|[Note](https://github.com/Cecilia-xu/Leetcode/blob/master/137/Note.md)|
## Math
| No | Title | Solution | Difficulty | Time | Space | Tag | Note |
| :----- | :-----: | :----------: |:------: |:------: |:------: |:------: |:----:|
