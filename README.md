...
| 209 | [Minimum Size Subarray Sum](https://leetcode.com/problems/minimum-size-subarray-sum/)|[Solution](https://github.com/Cecilia-xu/Leetcode/blob/master/209/Solution.md)|Medium|O(n)|O(1)|Array, Sliding window techinique|[Note](https://github.com/Cecilia-xu/Leetcode/blob/master/209/Note.md)|
