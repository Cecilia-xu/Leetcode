...
| 704 | [Binary Search](https://leetcode.com/problems/binary-search/)|[Solution](https://github.com/Cecilia-xu/Leetcode/blob/master/704/Solution.md)|Easy|O(logn)|O(1)|Array, binary search|[Note: binary search template & algorithms](https://github.com/Cecilia-xu/AlgorithmReview/blob/master/Searching/binary%20search.md)<br> [Note: about generics](https://github.com/Cecilia-xu/AlgorithmReview/blob/master/Searching/generics.md)|
